        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate">
            <div class="row">
              ...
              <div>
				...
				{
					$image = isset($row['image']) ? $row['image'] : 'default-food.jpg';
					echo '<tr>';
					echo '<td><img src="images/food/'.$image.'" alt="'.$row["name"].'" style="width: 60px; height: 60px; object-fit: cover; border-radius: 5px;" onerror="this.src=\'images/food/default-food.jpg\'"></td>';
...
<table>
				...
				<?php
					...
					echo '<td><div class="input-field col s12"><label for="image">Image Filename</label>';
					echo '<input id="image" name="image" type="text" placeholder="e.g., pizza-margherita.jpg" data-error=".errorTxt03"><div class="errorTxt03"></div></td>';
					echo '</tr>';
				?>
                    </tbody>
</table>
  ...
  <footer class="page-footer">
    ...
    // Fix: Output valid JavaScript object for rules using PHP
